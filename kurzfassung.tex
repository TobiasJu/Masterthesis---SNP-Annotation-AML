...
\textit{An dieser Stelle steht eine Zusammenfassung der Arbeit, Umfang
...
\textit{Kurzfassungen werden übrigens häufig -- zusammen mit Autor und Titel
der Arbeit -- %
...
\textit{Weiters sollte man daran denken, dass bei der Aufnahme in Datenbanken
Sonderzeichen oder etwa Aufzählungen mit "`Knödellisten"' in der
Regel verloren gehen. Dasselbe gilt natürlich auch für das 
\emph{Abstract}.}


\textit{Inhaltlich sollte die Kurzfassung \emph{keine} Auflistung der
