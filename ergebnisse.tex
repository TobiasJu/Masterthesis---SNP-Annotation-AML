...
\begin{figure}
    \centering
    \subfigure[EP mit \ac{SNP} Ile169Val.]{\includegraphics[width=.90\textwidth]{images/comp_plot_benign_MSH2_Ile169Val.png}}
    \subfigure[EP mit \ac{SNP} Gly164Trp.]{\includegraphics[width=.90\textwidth]{images/comp_plot_patho_MSH2_Gly164Trp.png}}
...
\begin{figure}
    \centering
    \subfigure[EP mit \ac{SNP} Met87Ile.]{\includegraphics[width=.95\textwidth]{images/comp_plot_ACADM_Met87Ile.png}}
    \subfigure[EP mit \ac{SNP} Ile78Thr.]{\includegraphics[width=.95\textwidth]{images/comp_plot_ACADM_Ile78Thr.png}}
...
%alle daten, da hier nur exemplarisch auf ergebnisse eingegangen werden kann wegen der fülle kann man in der mitgelieferten dvd finden oder so
...
\begin{table}[H]
    \centering
    \caption{Dargestellt sind alle alpha helicalen Membranproteine mit \ac{SNP}s, die auf den aufgeklärten Strukturen liegen. Die \texttt{SNP} Zeile gibt an welche Aminosäure an welcher Position ausgetauscht wurde. Die \texttt{ClinVar} Zeile zeigt die offizielle ClinVar Annotation des jeweiligen \ac{SNP}s an. Die \texttt{snp\_diff} Zeile zeigt die Differenz der Energie zwischen Mutation und Referenz. Die \texttt{snp\_diff\_amount} Zeile gibt die absolute Differenz zwischen Mutation und Referenz. Die \texttt{total\_diff} Zeile zeigt die Totale Energiedifferenz über die gesamte Polypeptidkette. Die \texttt{total\_contact\_diff} Zeile gibt die Energiedifferenz über alle Kontakte an. Pathogene \ac{SNP}s sind rot und benigne \ac{SNP}s sind grün markiert, die Tabelle ist aufsteigend nach der blauen Kopfzeile sortiert.}
    \label{tab:snps_memb}
    \resizebox{\linewidth}{!}{%
